...
from apps.libroMayor.api.serializers import LmSerializer, ListLmSerializer
from apps.libroMayor.models import LibroMayor


class LmViewSet(viewsets.GenericViewSet):
    model = LibroMayor
    serializer_class = LmSerializer
    list_serializer_class = ListLmSerializer
    ...
    def retrieve(self, request, pk=None):
        ...
        if record:
            record_serializer = LmSerializer(record)
