...
from apps.pagos.api.serializers import PagoSerializer, ListPagoSerializer
...
class PagoViewSet(viewsets.GenericViewSet):
    ...
    list_serializer_class = ListPagoSerializer
    ...
    def retrieve(self, request, pk=None):
        ...
        if record:
            record_serializer = PagoSerializer(record)
