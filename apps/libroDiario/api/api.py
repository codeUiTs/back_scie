...
from apps.libroDiario.api.serializers import LdSerializer, ListLdSerializer
from apps.libroDiario.models import LibroDiario


class LdViewSet(viewsets.GenericViewSet):
    model = LibroDiario
    serializer_class = LdSerializer
    list_serializer_class = ListLdSerializer
    ...
    def retrieve(self, request, pk=None):
        ...
        if record:
            record_serializer = LdSerializer(record)
